...
class SAHF_512:  # Secure Advanced Hashing Function # Duy Nam Sinus Aetheny Hashing Algorithm DNSA
    ...
    def hash(self) -> str:
        ...
        for pattern in replace["content"]:
            ...
            if self.data.__len__() <= 512 * self.difficulty:
                # Replace the pattern
...
# hasdh = SAHF_512("a", 20, difficulty=10)
# print(hasdh.hash())
